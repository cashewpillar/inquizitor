...
class CRUDQuizStudentLink(
    CRUDBase[QuizStudentLink, QuizStudentLinkCreate, QuizStudentLinkUpdate]
):
    def get_by_quiz_and_student_ids(
        ...
        return (
            ...
            .filter(
                QuizStudentLink.quiz_id == quiz_id,
                QuizStudentLink.student_id == student_id,
            )
            .first()
        )
